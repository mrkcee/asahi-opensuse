...
%define _rpm_ver %{_rcver}.0

# how the kernel release string (uname -r) should look like
%define kernelrelease %{_rcver}.0-asahi
...
Source2: 10-speakers-enable-part1.patch
Source3: 10-speakers-enable-part2.patch
...
# apply patches
mkdir -p patches
cp %{_sourcedir}/10-speakers-enable-part1.patch patches/
cp %{_sourcedir}/10-speakers-enable-part2.patch patches/
patch -ruN -d sound/soc/apple/ < patches/10-speakers-enable-part1.patch
patch -ruN -d sound/soc/apple/ < patches/10-speakers-enable-part2.patch
