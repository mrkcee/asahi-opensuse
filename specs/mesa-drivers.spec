...
%global asahi_mesa_ver 20240228
%global git_tag asahi-%{asahi_mesa_ver}
%global basever 24.1.0
...
%package -n Mesa-dri-asahi
Summary:        Mesa DRI plug-in for 3D acceleration on Apple Silicon
Group:          System/Libraries
Requires:       Mesa = %{version}

%description -n Mesa-dri-asahi
This package contains apple_dri.so and asahi_dri.so, which are necessary for 3D
acceleration on Apple Silicon to work. It is packaged separately
since it is still experimental.
...
%endif
  ...
  %else
  %ifarch %{arm} aarch64
            -Dgallium-drivers=r300,r600,radeonsi,nouveau,swrast,virgl,freedreno,vc4,etnaviv,lima,panfrost,v3d,svga,tegra,zink,asahi \
  %else
...
%exclude %{_libdir}/dri/asahi_dri.so
%endif
